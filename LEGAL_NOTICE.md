...
OpenAI, ChatGPT, Codex, and related names and marks are trademarks or other
protected brand identifiers of OpenAI or its affiliates.

Windows is a trademark of Microsoft Corporation. Delphi is a trademark of
Embarcadero Technologies. Raize Components is identified solely as a
third-party development dependency.

All other product names, trademarks, and registered trademarks belong to their
respective owners. Reference to a third-party product describes compatibility
or interoperability and does not imply endorsement.

OpenAI publishes current brand guidance at:
[openai.com/brand](https://openai.com/brand/).
